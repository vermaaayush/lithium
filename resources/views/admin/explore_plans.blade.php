                            ...
                            <tbody>
                                ...
                                <a href="#">
                                    <tr>
                                        ...
                                        <td class="border-b border-[#E6E6E6] dark:border-[#ffffff1a] text-[13px] py-2.5 px-5 font-normal whitespace-nowrap text-body-color"><a class="mr-1 mb-2 inline-block rounded font-medium py-[5px] px-[15px] text-[13px] border border-secondary text-white bg-secondary hover:bg-hover-secondary hover:border-hover-secondary duration-300 btn-sm" href="/v_plan">View</a><a class="mr-1 mb-2 inline-block rounded font-medium py-[5px] px-[15px] text-[13px] border border-primary text-white bg-primary hover:bg-hover-primary hover:border-hover-primary duration-300 btn-sm" href="/invest-now/{{ $data->id }}">Invest Now</a></td>
