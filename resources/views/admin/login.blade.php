            ...
            <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                    ...
                    @endif
                        ...
                        <form class="form-horizontal form-simple" action="/admin_login"  method="post">
                            {{ csrf_field() }}
                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                <input type="text" class="form-control form-control-lg input-lg" id="user-name" name="email" placeholder="Enter Email" required>
