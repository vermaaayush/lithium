...
<body class="selection:text-white selection:bg-primary">
   ...
   <!-- Main wrapper start -->
    <div id="main-wrapper" class="relative">
		...
		<!-- Chat box start -->
		<div class="chatbox max-sm:w-[17.5rem] w-[21.25rem] h-[100vh] bg-white dark:bg-[#182237] z-[999] duration-500 fixed top-0 right-[-31.25rem] shadow-[0rem_0rem_1.875rem_0rem_rgba(82,63,105,0.15)]">
			<div class="chatbox-close"></div>
			<div class="dz-tab-area">
				<ul class="nav nav-tabs flex justify-between flex-wrap bg-primary p-4 pb-0">
					<li class="nav-item">
						<a class="nav-link px-4 py-2 text-white uppercase opacity-70 border-b-[0.1875rem] border-transparent block duration-500 font-semibold text-sm hover:opacity-100 tab-btn" href="javascript:void(0);" data-tab="notes-tab">Notes</a>
					</li>
					<li class="nav-item">
						<a class="nav-link px-4 py-2 text-white uppercase opacity-70 border-b-[0.1875rem] border-transparent block duration-500 font-semibold text-sm hover:opacity-100 tab-btn" href="javascript:void(0);" data-tab="alerts-tab">Alerts</a>
					</li>
					<li class="nav-item">
						<a class="nav-link px-4 py-2 text-white uppercase opacity-70 border-b-[0.1875rem] border-transparent block duration-500 font-semibold text-sm hover:opacity-100 active tab-btn" href="javascript:void(0);" data-tab="chat-tab">Chat</a>
					</li>
				</ul>
				<div class="tab-content-area">
					<div class="tab-content active show" id="chat-tab">
						<div class="card sm:mb-4 mb-0 contacts_card dz-chat-user-box">
							<div class="card-header chat-list-header text-center flex justify-between py-[0.9375rem] px-[1.25rem] items-center border-b border-[#E6E6E6] relative dark:border-[#ffffff1a]">
								<a href="javascript:void(0);" class="w-[1.875rem] h-[1.875rem] bg-[#F3F0EC] rounded-md flex justify-center items-center"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect fill="#000000" x="4" y="11" width="16" height="2" rx="1"/><rect fill="#000000" opacity="1.0" transform="translate(12.000000, 12.000000) rotate(-270.000000) translate(-12.000000, -12.000000) " x="4" y="11" width="16" height="2" rx="1"/></g></svg></a>
								<div>
							...
							<div class="card-body contacts_body p-0 dz-scroll overflow-y-scroll overflow-x-hidden relative" id="DZ_W_Contacts_Body">
								<ul class="contacts">
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer">A</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="img_cont flex items-center justify-center w-10 h-10 bg-[#eee] rounded-full text-[13px] text-center font-semibold self-start mr-2.5 relative">
												...
												<span class="online_icon absolute w-3 h-3 rounded-full right-[-0.0625rem] bottom-0 border-2 border-white dark:border-[#182237]"></span>
											</div>
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Archie Parker</span>
									...
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="img_cont flex items-center justify-center w-10 h-10 bg-[#eee] rounded-full text-[13px] text-center font-semibold self-start mr-2.5 relative">
												...
												<span class="online_icon offline absolute w-3 h-3 rounded-full right-[-0.0625rem] bottom-0 border-2 border-white dark:border-[#182237]"></span>
											</div>
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Alfie Mason</span>
									...
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">AharlieKane</span>
									...
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Athan Jacoby</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Nargis left 30 mins ago</p>
											</div>
										</div>
									</li>
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer">B</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="img_cont flex items-center justify-center w-10 h-10 bg-[#eee] rounded-full text-[13px] text-center font-semibold self-start mr-2.5 relative">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Bashid Samim</span>
									...
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Breddie Ronan</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Kalid is online</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Ceorge Carson</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Taherah left 7 mins ago</p>
											</div>
										</div>
									</li>
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer">D</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="img_cont flex items-center justify-center w-10 h-10 bg-[#eee] rounded-full text-[13px] text-center font-semibold self-start mr-2.5 relative">
												<img src="assets/images/avatar/3.jpg" class="rounded-full w-full" alt="">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Darry Parker</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Sami is online</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Denry Hunter</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Nargis left 30 mins ago</p>
											</div>
										</div>
									</li>
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer">J</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="img_cont flex items-center justify-center w-10 h-10 bg-[#eee] rounded-full text-[13px] text-center font-semibold self-start mr-2.5 relative">
												<img src="assets/images/avatar/5.jpg" class="rounded-full w-full" alt="">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Jack Ronan</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Rashid left 50 mins ago</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Jacob Tucker</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Kalid is online</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">James Logan</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Taherah left 7 mins ago</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Joshua Weston</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Sami is online</p>
											</div>
										</div>
									</li>
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer">O</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="img_cont flex items-center justify-center w-10 h-10 bg-[#eee] rounded-full text-[13px] text-center font-semibold self-start mr-2.5 relative">
												<img src="assets/images/avatar/4.jpg" class="rounded-full w-full" alt="">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Oliver Acker</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Nargis left 30 mins ago</p>
											</div>
										</div>
									</li>
									<li class="dz-chat-user border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Oscar Weston</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">Rashid left 50 mins ago</p>
											</div>
										</div>
									</li>
						...
						<div class="card chat dz-chat-history-box hidden">
							<div class="card-header chat-list-header text-center flex justify-between py-[0.9375rem] px-[1.25rem] items-center border-b border-[#E6E6E6] relative dark:border-[#ffffff1a]">
								<a href="javascript:void(0);"  class="dz-chat-history-back w-[1.875rem] h-[1.875rem] bg-[#F3F0EC] rounded-md flex justify-center items-center">
								...
								<div class="dropdown relative">
									...
									<ul id="DzchatDropdown" class="dz-dropdown-menu dropdown-menu-end absolute translate-x-[-205px] translate-y-[8px] overflow-hidden rounded-md z-[9] bg-white dark:bg-[#182237] shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] min-w-[15rem] py-2 hidden text-left">
										<li class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"><i class="fa fa-user-circle text-primary mr-2"></i> View profile</li>
										<li class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"><i class="fa fa-users text-primary mr-2"></i> Add to btn-close friends</li>
										<li class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"><i class="fa fa-plus text-primary mr-2"></i> Add to group</li>
										<li class="dropdown-item py-2 px-5 text-body-color text-[13px] text-left block w-full whitespace-nowrap hover:bg-[#f8f9fa] hover:text-primary dark:hover:bg-[#151C2C]"><i class="fa fa-ban text-primary mr-2"></i> Block</li>
									</ul>
								</div>
							</div>
							<div class="card-body contacts_body p-4 dz-scroll overflow-y-scroll overflow-x-hidden relative" id="DZ_W_Contacts_Body3">
								...
								<div class="flex justify-end mb-6">
									<div class="msg_cotainer_send mr-2.5 bg-chat dark:bg-[#151C2C] text-dark py-2.5 px-[0.9375rem] relative rounded-md rounded-se-none text-sm text-left">
							...
							<div class="card-footer type_msg pt-2.5 px-[1.25rem] pb-4 border-t border-[#E6E6E6] dark:border-[#ffffff1a]">
								<div class="input-group relative flex flex-wrap items-stretch justify-between w-full">
									<textarea class="py-2.5 h-auto min-h-auto text-[13px] outline-none resize-none flex-auto w-[1%] dark:bg-[#182237]" placeholder="Type your message..."></textarea>
					...
					<div class="tab-content" id="alerts-tab">
						<div class="card sm:mb-4 mb-0 contacts_card">
							...
							<div class="card-body contacts_body p-0 dz-scroll overflow-y-scroll overflow-x-hidden relative" id="DZ_W_Contacts_Body1">
								<ul class="contacts">
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer text-[0.8125rem]">SEVER STATUS</li>
									<li class="border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">David Nester Birthday</span>
												<p class="text-[0.8125rem] text-primary leading-[1.2] max-w-[10.625rem]">Today</p>
											</div>
										</div>
									</li>
									<li class="name-first-letter py-1 px-4 bg-[#F3F0EC] dark:bg-[#151C2C] sticky z-[1] top-0 font-semibold border-b border-b-color dark:border-[#ffffff1a] cursor-pointer text-[0.8125rem]">SOCIAL</li>
									<li class="border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											...
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] font-medium leading-[1.2]">Perfection Simplified</span>
							...
							<div class="card-body contacts_body p-0 dz-scroll overflow-y-scroll overflow-x-hidden relative" id="DZ_W_Contacts_Body2">
								<ul class="contacts">
									<li class="border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] whitespace-nowrap font-medium leading-[1.2] text-ellipsis overflow-hidden">New order placed..</span>
									...
									<li class="border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] whitespace-nowrap font-medium leading-[1.2] text-ellipsis overflow-hidden">Youtube, a video-sharing website..</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">10 Aug 2020</p>
											</div>
											<div class="ml-auto">
												<a href="javascript:void(0);" class="btn bg-primary w-[1.625rem] h-[1.625rem] p-[0.1175rem] inline-block text-center text-white text-xs rounded-md leading-[1.9] mr-1"><i class="fas fa-pencil-alt"></i></a>
									...
									<li class="border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] whitespace-nowrap font-medium leading-[1.2] text-ellipsis overflow-hidden">john just buy your product..</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">10 Aug 2020</p>
											</div>
											<div class="ml-auto">
												<a href="javascript:void(0);" class="btn bg-primary w-[1.625rem] h-[1.625rem] p-[0.1175rem] inline-block text-center text-white text-xs rounded-md leading-[1.9] mr-1"><i class="fas fa-pencil-alt"></i></a>
									...
									<li class="border-b border-b-color dark:border-[#ffffff1a] py-3 px-4 cursor-pointer hover:bg-primary-light">
										<div class="flex items-center bd-highlight">
											<div class="user_info">
												<span class="text-dark text-[0.9375rem] mb-[0.3125rem] block max-w-[10.625rem] whitespace-nowrap font-medium leading-[1.2] text-ellipsis overflow-hidden">Athan Jacoby</span>
												<p class="text-[0.8125rem] text-body-color leading-[1.2] max-w-[10.625rem]">10 Aug 2020</p>
											</div>
											<div class="ml-auto">
												<a href="javascript:void(0);" class="btn bg-primary w-[1.625rem] h-[1.625rem] p-[0.1175rem] inline-block text-center text-white text-xs rounded-md leading-[1.9] mr-1"><i class="fas fa-pencil-alt"></i></a>
